    ...
    <section className="bg-white">
      <div className="w-full flex justify-center items-center">
        <div className="py-[20px] md:py-[46.36px] px-[20px] md:px-[48px] flex flex-col justify-center items-center">
          <p className="pt-[96px] text-[#666] text-[24px] md:text-[40px] leading-[48px] w-full text-center font-semibold tracking-[-2.4px]">
          ...
          <div className="flex justify-center flex-wrap md:flex-nowrap gap-[24px] pb-[95.71px] mt-[32px]">
            <button className="bg-[#09090B] w-[181px] h-[40px] flex justify-center items-center gap-[6px] px-[11px] py-[5.5px] rounded-[6px] font-medium">
              <LogoIcon />
              <span className="text-white">Lorem Ipsum</span>
            </button>
            <button className="border h-[40px] flex justify-center items-center gap-[6px] px-[11px] py-[12px] rounded-[6px] w-[191px] font-medium">
